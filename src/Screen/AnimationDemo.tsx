...
const AnimationDemo = () => {
    ...
    const handlePressForX = () => {
        const randomX = generateRandomNumber(0, Dimensions.get('window').width - (width.value + 10))
        const randomY = generateRandomNumber(0, Dimensions.get('window').height - (height.value + 10 + headerHeight))
